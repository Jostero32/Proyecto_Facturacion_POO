 ...
 * @author User
 */
public class Interfaz_Agregar_ProvCiu extends javax.swing.JFrame {
    int xMouse, yMouse;
    /**
     * Creates new form Interfaz_Agregar_ProvCiu
     */
    public Interfaz_Agregar_ProvCiu() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(TXT_Codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 160, 40));
        getContentPane().add(TXT_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 160, 40));

        jLabel2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Codigo:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 80, 40));

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
        jLabel3.setText("Nombre:");
        jLabel3.setOpaque(true);
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 60, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interfaz_Agregar_ProvCiu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaz_Agregar_ProvCiu().setVisible(true);
            }
        });
    }
