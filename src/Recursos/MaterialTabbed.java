...
public class MaterialTabbed extends JTabbedPane {
    ...
    public class MaterialTabbedUI extends MetalTabbedPaneUI {
        ...
        protected void paintTabBorder(Graphics grphcs, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
            ...
            g2.setColor(new Color(155, 20, 27));
            ...
            if (currentRectangle != null) {
                if (tabPlacement == TOP) {
                    ...
                    g2.fillRect(currentRectangle.x, currentRectangle.y, currentRectangle.width, 4);
                } else if (tabPlacement == LEFT) {
                    g2.fillRect(currentRectangle.x + currentRectangle.width - 4, currentRectangle.y, 4, currentRectangle.height);
                } else if (tabPlacement == RIGHT) {
                    g2.fillRect(currentRectangle.x, currentRectangle.y, 4, currentRectangle.height);
                }
            }
            g2.dispose();
        }
        ...
        protected void paintContentBorder(Graphics grphcs, int tabPlacement, int selectedIndex) {
            Graphics2D g2 = (Graphics2D) grphcs.create();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.setColor(new Color(37, 39, 44));
